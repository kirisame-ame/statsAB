...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerPolyNode<project::Griffin_Lufs<1>, scriptnode::wrap::illegal_poly<project::Griffin_Lufs<1>>>();
		registerPolyNode<project::ABAnalysisNetwork<1>, wrap::illegal_poly<project::ABAnalysisNetwork<1>>>();
		registerDataNode<project::SpectrumNetwork_networkdata>();
	}
};
